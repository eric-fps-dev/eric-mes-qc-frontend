<!--<template>-->
<!--  <div>-->
<!--    &lt;!&ndash; Toolbar with Search Bar and Add Button &ndash;&gt;-->
...
<!--&lt;!&ndash;                <p>{{ translate('userManagement.table.wecomId') }}: {{ scope.row.wecom_id }}</p>&ndash;&gt;-->
<!--              </template>-->
<!--              <template #reference>-->
...
<!--&lt;!&ndash;        <el-table-column :label="translate('userManagement.table.wecomId')" prop="wecom_id" width="180" sortable>&ndash;&gt;-->
<!--&lt;!&ndash;          <template #default="scope">&ndash;&gt;-->
<!--&lt;!&ndash;            <span>{{ scope.row.wecom_id }}</span>&ndash;&gt;-->
...
<!--        >-->
<!--          <template #default="scope">-->
<!--&lt;!&ndash;            <el-button size="small" class="custom-assign-button" @click="">&ndash;&gt;-->
<!--&lt;!&ndash;              Assign&ndash;&gt;-->
...
<!--    >-->
<!--      &lt;!&ndash; Translate the Total &ndash;&gt;-->
<!--      <template #total>-->
<!--        {{ translate('pagination.total', { total: filteredData.length }) }}-->
<!--      </template>-->

<!--      &lt;!&ndash; Translate the /page &ndash;&gt;-->
<!--      <template #sizes>-->
...
<!--&lt;!&ndash;          <el-form-item :label="translate('userManagement.addDialog.wecomId')" prop="wecomId">&ndash;&gt;-->
<!--&lt;!&ndash;            <el-input&ndash;&gt;-->
<!--&lt;!&ndash;                v-model="newUser.wecomId"&ndash;&gt;-->
<!--&lt;!&ndash;            />&ndash;&gt;-->
...
<!--&lt;!&ndash;          <el-form-item :label="translate('userManagement.editDialog.wecomId')" prop="wecomId">&ndash;&gt;-->
<!--&lt;!&ndash;            <el-input v-model="editUser.wecomId" />&ndash;&gt;-->
<!--&lt;!&ndash;          </el-form-item>&ndash;&gt;-->
...
<!--        if (response.data.status === '200') {-->
<!--          const sortedData = response.data.data.content.sort((a, b) => a.id - b.id); // Sort by ID-->

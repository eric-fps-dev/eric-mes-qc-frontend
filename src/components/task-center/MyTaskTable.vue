...
<!--        &lt;!&ndash; Left Section: Title &ndash;&gt;-->
...
<!--        &lt;!&ndash; Right Section: Search Input, Tooltip, and Refresh Button &ndash;&gt;-->
...
<!--              @change="applyFilter"-->
<!--          />-->
<!--&lt;!&ndash;          <el-tooltip content="请求新任务给我做" placement="top">&ndash;&gt;-->
<!--&lt;!&ndash;            <el-button type="primary" @click="showFeatureDevelopmentMessage"> + 请求新任务</el-button>&ndash;&gt;-->
...
<!--              </el-tag>-->
<!--            </span>-->
<!--&lt;!&ndash;            <span v-else-if="key === 'is_overdue'">&ndash;&gt;-->
<!--&lt;!&ndash;              <el-tag :type="scope.row[key] ? 'danger' : 'info'">&ndash;&gt;-->
<!--&lt;!&ndash;                {{ scope.row[key] ? '是' : '否' }}&ndash;&gt;-->
<!--&lt;!&ndash;              </el-tag>&ndash;&gt;-->
<!--&lt;!&ndash;            </span>&ndash;&gt;-->
...
<!--&lt;!&ndash;                  <div>角色: {{ personnelMap[scope.row[key]]?.role || '未知' }}</div>&ndash;&gt;-->
<!--                </template>-->
<!--                <template #reference>-->
<!--                  <el-tag type="primary">-->
...
<!--        this.personnelMap = response.data?.data?.content.reduce((map, person) => {-->

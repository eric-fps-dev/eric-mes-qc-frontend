export default {
    ...
    navigationMenu: {
        ...
        qualityManagement: "QC Management",
    ...
    QcSummary: {
        ...
        for: 'for',
        tour: {
            introTitle: 'Welcome to QC Summary',
            introDesc: 'This dashboard provides a comprehensive overview of quality control metrics.',
            filterTitle: 'Filter Data',
            filterDesc: 'Use these filters to refine the data by date range, team, shift, product, or batch.',
            chartTitle: 'Interactive Charts',
            chartDesc: 'Click on any chart element (bar, point, or slice) to drill down and see the specific inspection records behind the data.',
            tableTitle: 'Detailed Tables',
            tableDesc: 'Click on the numbers in the table columns (Total, Abnormal) to view the corresponding list of inspection records.',
            exportTitle: 'Export & Subscribe',
            exportDesc: 'Download the current report as a PDF/Excel or subscribe to receive weekly email summaries.'
        }
    },
